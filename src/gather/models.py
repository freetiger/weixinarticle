...
class WeixinArticle(models.Model):
    ...
    #content=UEditorField(u'文章内容   ',width=600, height=300, toolbars="full", imagePath="", filePath="", upload_settings={"imageMaxSize":1204000},settings={},command=None,blank=True)
